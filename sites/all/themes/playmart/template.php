...
/*
function playmart_preprocess_html(&$vars) {
  //  kpr($vars['content']);
}
*/
...
*/
/*
function playmart_preprocess_block(&$vars, $hook) {
  //  kpr($vars['content']);
...
*/
/*
function playmart_preprocess_node(&$vars,$hook) {
  //  kpr($vars['content']);
...
*/
/*
function playmart_preprocess_comment(&$vars,$hook) {
  //  kpr($vars['content']);
}
*/
/*
function playmart_preprocess_field(&$vars,$hook) {
  //  kpr($vars['content']);
...
*/
/*
function playmart_preprocess_maintenance_page(){
  //  kpr($vars['content']);
}
*/
/*
function playmart_form_alter(&$form, &$form_state, $form_id) {
  //if ($form_id == '') {
  //....
  //}
}
