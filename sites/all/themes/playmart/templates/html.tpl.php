<!doctype html>
<!--[if IEMobile 7]><html class="no-js ie iem7" <?php print $html_attributes; ?>><![endif]-->
<!--[if lt IE 7]><html class="no-js ie6 ie oldie" <?php print $html_attributes; ?>><![endif]-->
<!--[if (IE 7)&!(IEMobile)]><html class="no-js ie ie7 oldie" <?php print $html_attributes; ?>><![endif]-->
<!--[if (IE 8)&!(IEMobile)]><html class="no-js ie ie8 oldie" <?php print $html_attributes; ?>><![endif]-->
<!--[if gt IE 8]><html class="no-js ie9" <?php print $html_attributes; ?>><![endif]-->
<!--[if (gte IE 9)|(gt IEMobile 7)]><html class="no-js ie7"  <?php print $rdf_namespaces; ?>><![endif]-->
